                        ...
                        <li>
                            ...
                            <ul class="sub_menu">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="user/category/<?php echo e($item->id); ?>"><?php echo e($item->name); ?></a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub_menu">
                                <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="user/collection/<?php echo e($item->id); ?>"><?php echo e($item->name); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </li>
...
<section class="slide1">
    <div class="wrap-slick1">
        <div class="slick1">
            <div class="item-slick1 item1-slick1" style="background-image: url('<?php echo e(asset('img/silde/slide2.jpg')); ?>');">
            ...
            <div class="item-slick1 item2-slick1" style="background-image: url('<?php echo e(asset('img/silde/slide1.jpg')); ?>');">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15"
                              data-appear="rollIn">
							Bộ sưu tập 2018
            ...
            <div class="item-slick1 item1-slick1" style="background-image: url('<?php echo e(asset('img/silde/slide4.jpg')); ?>');">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15"
            ...
            <div class="item-slick1 item3-slick1" style="background-image: url('<?php echo e(asset('img/silde/slide3.jpg')); ?>');">
                <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15"
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class=" p-l-15 p-r-15 col-md-3 mt-3">
                    <!-- Block2 -->
                    <div class="block2">
                        <div class="block2-img wrap-pic-w of-hidden pos-relative<?php echo e($item->sale != 0 ? ' block2-labelsale' : ''); ?><?php echo e($item->new == 1 ? ' block2-labelnew' : ''); ?>">
                            
                            <div style="height: 350px; background-image: url('<?php echo e(asset('img/product/'. $item->images)); ?>');
                        ...
                        <div class="block2-txt p-t-20">
                            <a href="/user/product/<?php echo e($item->id); ?>" class="block2-name dis-block s-text3 p-b-5">
                                <?php echo e($item->name); ?>

                            </a>
                            <?php if($item->sale == 0): ?>
                                <span class="block2-price m-text6 p-r-5">
                                    <?php echo e(number_format($item->price,0,',','.')); ?> <span style="text-transform: lowercase">vnđ</span>
                                </span>
                            <?php else: ?>
                ...
                <div class="slick2">
                    <?php $__currentLoopData = $products_sale; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item-slick2 p-l-15 p-r-15">
                            <!-- Block2 -->
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative<?php echo e($item->sale != 0 ? ' block2-labelsale' : ''); ?> ">
                ...
                <div class="slick2">
                    <?php $__currentLoopData = $products_new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item-slick2 p-l-15 p-r-15">
                            <!-- Block2 -->
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative<?php echo e($item->new == 1 ? ' block2-labelnew': ''); ?>">
        ...
        <div class="row">
            <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
                <div class="hov-img-zoom pos-relative">
                    <img src="<?php echo e(asset('images/banner-08.jpg')); ?>" alt="IMG-BANNER">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
                <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
                    <img src="<?php echo e(asset('images/shop-item-09.jpg')); ?>" alt="IMG-BANNER">
