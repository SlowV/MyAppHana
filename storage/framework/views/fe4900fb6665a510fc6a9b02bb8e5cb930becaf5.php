<?php $__env->startSection('page-title', 'Danh sách sản phẩm - Hana Store'); ?>
...
<?php $__env->startSection('css'); ?>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/noui/nouislider.min.css')); ?>">
    <!--===============================================================================================-->
...
<?php $__env->startSection('content'); ?>
    <!-- Title Page -->
    <section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url('<?php echo e(asset('img/bg-list.jpg')); ?>');">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
                    <div class="leftbar p-r-20 p-r-0-sm">
                        ...
                        <ul class="p-b-54">
                            <li class="p-t-4">
                                <a href="<?php echo e(url()->current().'?categoryId=0'); ?>" class="s-text13<?php echo e($selected_categoryId==0?' active1':''); ?>">
                                    Tất cả
                                </a>
                            </li>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="p-t-4">
                                    <a href="<?php echo e(url()->current().'?categoryId='.$item->id); ?>" class="s-text13<?php echo e($selected_categoryId==$item->id?' active1':''); ?>">
                        ...
                        <ul class="p-b-54">
                            <li class="p-t-4">
                                <a href="<?php echo e(url()->current().'?collectionId=0'); ?>" class="s-text13<?php echo e($selected_collectionId==0?' active1':''); ?>">
                                    Tất cả
                                </a>
                            </li>
                            <?php $__currentLoopData = $collections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="p-t-4">
                                    <a href="<?php echo e(url()->current().'?collectionId='.$item->id); ?>" class="s-text13<?php echo e($selected_collectionId==$item->id?' active1':''); ?>">
                                        <?php echo e($item->name); ?>
                ...
                <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                    ...
                    <div class="flex-sb-m flex-w p-b-35">
                        ...
                        <span class="s-text8 p-t-5 p-b-5" id="show-name-filter">
                            <?php echo e($selected_categoryId!=0?'Danh mục "'.$selected_category->name . '"':''); ?>

                            <?php echo e($selected_collectionId!=0?'Bộ sư tập "'.$selected_collection->name.'"':''); ?>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
                                ...
                                <div class="block2">
                                    <div class="block2-img wrap-pic-w img-product-home of-hidden pos-relative<?php echo e($item->sale != 0 && $item->new != 1?' block2-labelsale':''); ?><?php echo e($item->new == 1 && $item->sale == 0? ' block2-labelnew':''); ?><?php echo e($item->sale != 0 && $item->new == 1 ? ' block2-labelsaleandnew' : ''); ?>">
                                        <img src="<?php echo e($item->images); ?>" alt="IMG-PRODUCT" style="height: 350px;object-fit: cover;">
                                        <div class="block2-overlay trans-0-4">
                                            ...
                                            <div class="block2-btn-addcart w-size1 trans-0-4 add-to-cart" id="add-cart-<?php echo e($item->id); ?>">
                                                <!-- Button -->
                                    ...
                                    <div class="block2-txt p-t-20">
                                        ...
                                        <?php echo e(number_format($item->price,0,',','.')); ?> (VND)
                                    </span>
                                        <?php else: ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <!--===============================================================================================-->
    <script src="<?php echo e(asset('js/list-product.js')); ?>"></script>
