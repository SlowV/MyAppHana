...
<div class="t-center p-l-15 p-r-15">
    <a href="javascript:void(0)" class="showPopup">
        <img class="h-size2" src="{{secure_asset('images/icons/paypal.png')}}" alt="IMG-PAYPAL">
    </a>

    <a href="javascript:void(0)" class="showPopup">
        <img class="h-size2" src="{{secure_asset('images/icons/visa.png')}}" alt="IMG-VISA">
    </a>

    <a href="javascript:void(0)" class="showPopup">
        <img class="h-size2" src="{{secure_asset('images/icons/mastercard.png')}}" alt="IMG-MASTERCARD">
    </a>

    <a href="javascript:void(0)" class="showPopup">
        <img class="h-size2" src="{{secure_asset('images/icons/express.png')}}" alt="IMG-EXPRESS">
    </a>

    <a href="javascript:void(0)" class="showPopup">
        <img class="h-size2" src="{{secure_asset('images/icons/discover.png')}}" alt="IMG-DISCOVER">
    </a>
